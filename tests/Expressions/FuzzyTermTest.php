...
it('gets documents matching a fuzzy term: ', function (?int $distance, ?bool $cost, ?bool $prefix, string $expression) {
    ...
    'no options' => [null, null, null, "paradedb.fuzzy_term(field => 'description', value => 'wolo', distance => NULL::integer, tranposition_cost_one => NULL::boolean, prefix => NULL::boolean)"],
