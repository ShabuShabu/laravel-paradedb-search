...
```php
use Tpetry\QueryExpressions\Value\Value;use Tpetry\QueryExpressions\Language\Alias;use ShabuShabu\ParadeDB\Operators\Distance;use ShabuShabu\ParadeDB\Expressions\v1\Score;use ShabuShabu\ParadeDB\Expressions\v2\Similarity;use ShabuShabu\ParadeDB\Expressions\v2\Support\Rank;use Tpetry\QueryExpressions\Operator\Arithmetic\Add;use Tpetry\QueryExpressions\Operator\Arithmetic\Divide;use Tpetry\QueryExpressions\Function\Conditional\Coalesce;
